...
function sanitize(input) {
  ...
  return {
    theatre: { name: str(th.name, 100), tagline: str(th.tagline, 200), about: str(th.about, 3000), pressText: str(th.pressText, 6000), venue: str(th.venue, 120), address: str(th.address, 200),
