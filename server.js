...
function sanitize(input) {
  ...
  return {
    theatre: { name: str(th.name, 100), tagline: str(th.tagline, 200), about: str(th.about, 3000), pressText: str(th.pressText, 6000), pressLead: str(th.pressLead, 400), pressContact: str(th.pressContact, 300), pressCredit: str(th.pressCredit, 120), logoColor: ['acid', 'white'].includes(th.logoColor) ? th.logoColor : '', pressHide: arr(th.pressHide).slice(0, 500).map(x => img(x)).filter(Boolean), venue: str(th.venue, 120), address: str(th.address, 200),
